...
!(function(e, t) {
    ...
    function i(e, t, r) {
        ...
        for (
            var n, a, u = /uniform (\w+) (\w+)/g, h = e + t; null != (n = u.exec(h));
        ...
        h = (function() {
            function e(e, t, i) {
                var o = "OES_texture_" + e,
                    ...
                    s = [o];
                return (
                    a && s.push(n), { type: t, arrayType: i, linearSupport: a, extensions: s }
                );
            }
        ...
        setupPointerEvents: function() {
            ...
            this.$el
                ...
                .on("touchmove.ripples touchstart.ripples", function(e) {
                    for (
                        var r = e.originalEvent.changedTouches, i = 0; i < r.length; i++
                    )
                        t(r[i]);
                })
